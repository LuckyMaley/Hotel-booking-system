...
const AdminPage = () => {
  ...
  return (
    <div className="admin-page">
      ...
      <div className="admin-body">
        ...
        <div className="sidebar">
          ...
          <ul className="sidebar-links">
            <li><a href="#add-owner" onClick={() => setShowForm(true)}>Add Hotel Owner</a></li>
            <li><a href="/owner-overview">Owner Overview</a></li>
            <li><a href="/coming-soon">Account Statement</a></li>
      ...
      {showForm && (
        <div className="modal">
          <div className="modal-content add-owner-form-input">
